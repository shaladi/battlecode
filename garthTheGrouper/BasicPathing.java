...
public class BasicPathing{
	...
	public static void snail(RobotController rc, MapLocation location, boolean selfAvoiding, boolean sneak) throws GameActionException{
		Direction chosenDirection = rc.getLocation().directionTo(location);
